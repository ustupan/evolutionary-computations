...
def set_toolbox(toolbox, classifier, number_of_atributtes, df, y):
    if classifier == 1:
        ...
        toolbox.register("individual", NuSVCParametersFeatures, number_of_atributtes, creator.Individual)
        toolbox.register("evaluate", NuSVCParametersFeatureFitness, y, df, number_of_atributtes)
        toolbox.register("mutate", mutationNuSVC)
    elif classifier == 6:
